...
static void ImGui_ImplDX12_SetWindowSize(ImGuiViewport* viewport, ImVec2 size)
{
    ...
    (void)data; (void)size;
    data->Context->Flush();
    data->Context->CleanupRenderTargetViews();
    // TODO: Change argument to size instead of viewport
    data->Context->ResizeSwapChain(size);
    data->Context->CreateRenderTargetViews();
    data->Context->ExecuteQueue();    
}
